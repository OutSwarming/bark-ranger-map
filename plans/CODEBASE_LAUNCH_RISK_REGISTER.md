...
| P2 paid launch | Oversized backend file | `functions/index.js` | 2,223 lines mixes ORS, Lemon, access codes, leaderboard, Gemini, Sheets | Payment code becomes harder to safely change | Split into modules after private beta | Medium/Large | Medium if test-first | Full functions suite + emulator + webhook tests |
